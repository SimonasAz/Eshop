...
export default async function EditTrendingGame({ params }) {
  ...
  return (
    <div className="container py-5">
      <h2 className="mb-4 text-primary">✏️ Edit Trending Game</h2>
      <form action={handleEdit} encType="multipart/form-data">
        <div className="mb-3">
